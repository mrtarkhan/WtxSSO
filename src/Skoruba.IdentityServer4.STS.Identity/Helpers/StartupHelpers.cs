...
namespace Skoruba.IdentityServer4.STS.Identity.Helpers
{
	public static class StartupHelpers
	{
			...
			where TUserIdentityRole : class
		{
			...
			//custom
			services.AddTransient<IProfileService, ProfileService<IdentityUser<Guid>, Guid>>();
			...
			IConfiguration configuration)
		{
			...
			if (externalProviderConfiguration.UseLinkedinProvider)
			{
				authenticationBuilder.AddLinkedIn(options =>
				{
					options.ClientId = externalProviderConfiguration.LinkedinClientId;
					options.ClientSecret = externalProviderConfiguration.LinkedinClientSecret;
					options.Scope.Add("user:email");
				});
			}
		}
